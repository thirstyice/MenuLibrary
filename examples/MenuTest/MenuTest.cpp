...
MenuValue<uint8_t> menuValueTest(&valueTest, 255);
MenuValue<float> menuValueTestFloat(&valueTestFloat, 1,0,0.1);
MenuValues menuValue("Value", &menuOverridden, &menuValueTest, &menuValueTestFloat);
